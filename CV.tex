...
Architect by training and \textbf{Computer Scientist} by profession, my activity strided from \textbf{industry} to \textbf{academia}, from Architecture to \textbf{Artificial Intelligence}. I have excellent skills in Python and C\# programming, as well as excellent knowledge of \textbf{Reinforcement Learning}, \textbf{Deep Learning} and Software Architecture.
\end{rSection}
