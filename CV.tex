...
\begin{rSection}{Work and Industry Experience}
    \begin{enumerate}[leftmargin=0.45cm, itemsep=0.4em, topsep=0.5em, parsep=0.2em]
        ...
        \textbf{Imperial College} \hfill	\textit{London, UK - September 2019 to \textbf{present}} \\
        ...
        \textbf{BuroHappold Engineering} \hfill \textit{London, UK - September 2018 to \textbf{present}} \\
...
\begin{rSection}{Teaching Experience}
    \begin{enumerate}[leftmargin=0.45cm, itemsep=0.4em, topsep=0.5em, parsep=0.2em]
        \item \textbf{Machine Learning and Computer Vision} \\
            ...
            \vskip 0.1em
            \textit{Within the executive education program for \textbf{Sberbank} I explained scalable object recognition methods using vocabulary trees and deep convolutional neural networks.}
