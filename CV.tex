...
Address: \href{https://goo.gl/maps/Gwa9BTP2ARx}{25 Bellefields rd., SW99UH, Brixton, London, United Kingdom} \\
...
\begin{rSection}{Education}
    \begin{enumerate}[leftmargin=0.45cm, itemsep=1em, topsep=0.5em, parsep=0.2em]
        ...
        \vskip 0.05em
        \textit{I am conducting research on the temporal credit assignment problem in non-stationary reinforcement learning, and how non-stationarity contributes to the failures mode of canonical model-free algorithms. Major applications are in Continual Reinforcement Learning. The position is funded by a scholarship from the Engineering and Physical Sciences Research Council (EPSRC).}        
        % \textit{I am conducting research on the effects of non-stationarity in reinforcement learning and how it contributes to the failures mode of canonical model-free algorithms. Major applications are in Continual Reinforcement Learning and the catastrophic forgetting problem. The PhD is funded by a scholarship from the Engineering and Physical Sciences Research Council (EPSRC).}
        \item
...
\begin{rSection}{Work and Industry Experience}
    \begin{enumerate}[leftmargin=0.45cm, itemsep=1em, topsep=0.5em, parsep=0.2em]
        ...
        \vskip 0.1em
        \textit{I am leading the applied research in Machine Learning to help understand how AI can create value for the business. We are democratising the access to Deep Learning technologies to allow every employee access the knowledge and the tools. We exploit Visual Programming, a recognised and diffused tool for design, to create a framework that interoperates between the most common deep learning libraries, tensorflow, keras, pytorch, numpy. The position is part of the wider computational core team that brings together discipline leads into a centralised research team bhom.xyz. The BHoM is currently adopted in different companies and is at the base of the project funded by Innovate UK, github.com/aecdeltas, which I advise for.}
        ...
        \item \textbf{Computational Designer (Machine Learning Scientist)} \\
        \textbf{BuroHappold Engineering}\hfill	\textit{London, UK - August 2017 to August 2018}
        ...
        \vskip 0.1em
        \textit{I provided support for the parametric modelling of façade of a multi-purpose shopping centre.}
...
\begin{rSection}{Teaching Experience}
    \begin{enumerate}[leftmargin=0.45cm, itemsep=0.4em, topsep=0.5em, parsep=0.2em]
        \item \textbf{Deep Reinforcement Learning} \\
            \textbf{Defense Science and Technology Laboratory}\hfill	\textit{London, UK - March 2021}
            \vskip 0.1em
            \textit{With UCL Consultants, I taught a practical application of Deep Reinforcement Learning.}    
        \item \textbf{Machine Learning and Computer Vision} \\
        ...
        \item \textbf{Teaching Assistant: Technology for Architecture Studio} \\
        ...
        \item \textbf{Tutor in Computational design} \\
