\begin{industryExperience}
    \begin{enumerate}[leftmargin=0.45cm, itemsep=1em, topsep=0.5em, parsep=0.2em]
        ...
        Skills: Python, Supervised learning, Unsupervised learning, NoSql, Tensorflow, Pytorch, Azure, AWS, Cloud computing, Docker, C\#, JavaScript, Git, Agile development, SCRUM, UI, UX, MongoDB.
